...
def load_save(save_file: BinaryIO) -> None:
    ...
    session = next(get_db())
    load_stadiums(save_data, session)
    load_schools(save_data, file_year, session)
    load_players(save_data, file_year, session)
    load_coaches(save_data, file_year, session)


def load_stadiums(save_data: dict[str, list[dict]], session: Session):
...
def load_schools(save_data: dict[str, list[dict]], year: int, session: Session):
...
def load_coaches(save_data: dict[str, list[dict]], year: int, session: Session):
...
def load_players(save_data: dict[str, list[dict]], year: int, session: Session):
